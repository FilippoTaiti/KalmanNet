...
# sequence length
T = 200 #Lunghezza delle sequenze di training e di validation
...
### training parameters ##################################################
N_steps = 500 # Numero epoche #200 50
...
[MSE_cv_linear_epoch, MSE_cv_dB_epoch, MSE_train_linear_epoch, MSE_train_dB_epoch] = KalmanNet_Pipeline.NNTrain(sys_model, cv_input, cv_target, train_input, train_target, path_results, CompositionLoss, True)
