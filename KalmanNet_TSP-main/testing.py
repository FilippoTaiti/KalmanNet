...
from Simulations.utils import DataGen, DataTestGen, plot_results
...
T_test = 1000 #lunghezza delle sequenze di test
...
if randomLength:
   [test_input, test_target, test_init, test_lengthMask] = torch.load(dataFolderName + dataFileName, map_location=device)
else:
